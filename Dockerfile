...
ENV CMAKE_ARGS="-DGGML_BLAS=ON -DGGML_BLAS_VENDOR=OpenBLAS -DGGML_NATIVE=OFF -DLLAMA_NATIVE=OFF -DCMAKE_C_FLAGS='-mavx -mavx2 -mfma -mf16c' -DCMAKE_CXX_FLAGS='-mavx -mavx2 -mfma -mf16c'"
